...
export const PLATFORM_GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    intro:
      'BeWork est un assistant travaux externalisé pour les entreprises d\'exécution. Il accompagne la gestion administrative, documentaire et opérationnelle des chantiers — marchés publics (AO, DCE, mémoires) et privés (promoteur, lots, réserves). BeWork ne remplace pas la MOE : il renforce l\'entreprise travaux.',
    items: [
      'Public : entreprises du bâtiment et des travaux publics — conducteurs de travaux, équipes bureau et chantier.',
      'BeWork prépare, structure et alerte : documents, tableaux, synthèses, relances, DOE et preuves.',
      'Marchés publics : AO, DCE, RC, mémoire technique, conformité des offres, situations.',
      'Marchés privés : courriers promoteur, réserves, DOE, relances, devis modificatifs.',
      'Tout élément engageant (prix, délai, variante, réponse contractuelle) doit être validé par l\'entreprise avant envoi.',
      'BeWork ne se substitue pas à un BET, un architecte, un bureau de contrôle, à la MOE ni à un conseil juridique.',
    ],
    emphasis: 'info',
  },
  {
