...
export function Quiz({ lotInitial }: { lotInitial?: QuizLotInitial | null }) {
  ...
  if (modeSpecialMillasNord) {
    return <QuizMillasNordSpecial onRetour={() => setModeSpecialMillasNord(false)} />;
  }

  if (modeSpecialMillasNordSecondOeuvre) {
    return (
      <QuizMillasNordSecondOeuvreSpecial
        onRetour={() => setModeSpecialMillasNordSecondOeuvre(false)}
      />
    );
  }
      ...
      <div className="space-y-5">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <QuizLotEncart
            ...
            gradientClass="bg-gradient-to-r from-indigo-50 to-violet-50"
          ...
          <QuizLotEncart
            ...
            gradientClass="bg-gradient-to-r from-rose-50 to-pink-50"
            labelClass="text-rose-900"
            buttonClass="bg-rose-600 hover:bg-rose-700"
            icon={<DoorOpen className="h-4 w-4" aria-hidden />}
            onLancer={() => setModeSpecialMillasNordSecondOeuvre(true)}
          />
          <QuizLotEncart
            featured
            lotLabel="Débutant"
          ...
          <QuizLotEncart
            featured
            lotLabel="Débutant"
            titre="Bases du gros œuvre"
            description="14 questions : implantation, fondations, armatures HA et règles d'enrobage."
            borderClass="border-amber-300/60"
            gradientClass="bg-gradient-to-r from-amber-50 to-orange-50"
            labelClass="text-amber-900"
            buttonClass="bg-amber-600 hover:bg-amber-700"
            icon={<HardHat className="h-4 w-4" aria-hidden />}
            onLancer={() => setModeSpecialBasesGo(true)}
          />
          <QuizLotEncart
            featured
            lotLabel="Débutant"
